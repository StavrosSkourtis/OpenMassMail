...
namespace OpenMassSenderCore {
    ...
    public partial class OpenMassSenderDBDataSet : global::System.Data.DataSet {
        ...
        public partial class JobDataTable : global::System.Data.TypedTableBase<JobRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public JobRow AddJobRow(SenderAccountRow parentSenderAccountRowBySenderAccountJob, MessageRow parentMessageRowByMessageJob, string status, int user, string query, string group) {
...
namespace OpenMassSenderCore.OpenMassSenderDBDataSetTableAdapters {
    ...
    public partial class AccountTypeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("type_name", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "type_name", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[2] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        type_name\r\nFROM            AccountType\r\nWHERE        (ID = ?)";
        ...
        public virtual int Fill(OpenMassSenderDBDataSet.AccountTypeDataTable dataTable) {
        ...
        public virtual OpenMassSenderDBDataSet.AccountTypeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            OpenMassSenderDBDataSet.AccountTypeDataTable dataTable = new OpenMassSenderDBDataSet.AccountTypeDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OpenMassSenderDBDataSet.AccountTypeDataTable dataTable) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> GetTypeIdByName(string type_name) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual string GetTypeNameById(int ID) {
    ...
    public partial class JobTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Job` WHERE ((`ID` = ?) AND ((? = 1 AND `sender_account` IS NULL) OR (`sender_account` = ?)) AND ((? = 1 AND `message` IS NULL) OR (`message` = ?)) AND ((? = 1 AND `status` IS NULL) OR (`status` = ?)) AND ((? = 1 AND `user` IS NULL) OR (`user` = ?)) AND ((? = 1 AND `query` IS NULL) OR (`query` = ?)) AND ((? = 1 AND `group` IS NULL) OR (`group` = ?)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_ID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ID", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Job` SET `sender_account` = ?, `message` = ?, `status` = ?, `user` = ?, `query` = ?, `group` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `sender_account` IS NULL) OR (`sender_account` = ?)) AND ((? = 1 AND `message` IS NULL) OR (`message` = ?)) AND ((? = 1 AND `status` IS NULL) OR (`status` = ?)) AND ((? = 1 AND `user` IS NULL) OR (`user` = ?)) AND ((? = 1 AND `query` IS NULL) OR (`query` = ?)) AND ((? = 1 AND `group` IS NULL) OR (`group` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        ID, sender_account, message, status, [user], query, [group]\r\nFROM  " +
                "          Job";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ID, [group], message, query, sender_account, status, [user] FROM Job WHERE" +
                " (ID = ?)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ID, global::System.Nullable<int> Original_sender_account, global::System.Nullable<int> Original_message, string Original_status, global::System.Nullable<int> Original_user, string Original_query, string Original_group) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(global::System.Nullable<int> sender_account, global::System.Nullable<int> message, string status, global::System.Nullable<int> user, string query, string group) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> sender_account, global::System.Nullable<int> message, string status, global::System.Nullable<int> user, string query, string group, int Original_ID, global::System.Nullable<int> Original_sender_account, global::System.Nullable<int> Original_message, string Original_status, global::System.Nullable<int> Original_user, string Original_query, string Original_group) {
            if ((sender_account.HasValue == true)) {
            ...
            if ((Original_user.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_user.Value));
            }
            else {
            ...
            if ((Original_query == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_query));
            }
            if ((Original_group == null)) {
    ...
    public partial class JobScheduleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT job, repeatable, nextExecution, lastExecution FROM JobSchedule WHERE job=?" +
                "";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
    ...
    public partial class MessageTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ID, message, subject, [user], type, job, replaceVariables FROM Message WHE" +
                "RE id=?";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ID", global::System.Data.DataRowVersion.Current, false, null));
        }
    ...
    public partial class ReceiverTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        Receiver.ID, Receiver.first_name, Receiver.last_name, Receiver.email, Receiver.phone_number, Receiver.metadata, Receiver.[group], Receiver.[user]
FROM            (Receiver INNER JOIN
                         [Group] ON Receiver.[group] = [Group].ID)
WHERE        ([Group].group_name = ?)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("group_name", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "group_name", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[2] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT ID, first_name, last_name, email, phone_number, metadata, [group], [user] " +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByGroupName(OpenMassSenderDBDataSet.ReceiverDataTable dataTable, string group_name) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((group_name == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual OpenMassSenderDBDataSet.ReceiverDataTable GetDataByGroupName(string group_name) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((group_name == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
    ...
    public partial class SenderAccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        ID, email, first_name, last_name, host, port, sms_url, [user], type" +
                "\r\nFROM            SenderAccount\r\nWHERE        (ID = ?)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ID", global::System.Data.DataRowVersion.Current, false, null));
        }
